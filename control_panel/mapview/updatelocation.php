<?php
    ...
    switch ($dbType) {
        case DB_MYSQL:
            $stmt1 = $pdo->prepare($sqlFunctionCallMethod.'prcDeleteRoute(:sessionid)');     
        ...
        case DB_MYSQL1:
            $stmt = $pdo->prepare('UPDATE INTO gpslocations (latitude, longitude, speed, direction, distance, gpsTime, locationMethod, userName, phoneNumber,  sessionID, accuracy, extraInfo, eventType) VALUES (:latitude, :longitude, :speed, :direction, :distance, :date, :locationmethod, :username, :phonenumber, :sessionid, :accuracy, :extrainfo, :eventtype)');
            break;
