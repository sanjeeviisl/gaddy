...
include "header.php"
?>
<script src="mapview/js/updated_maps.js"></script>
<div ui-view>
	<div style="position:relative;left:225px;top:0px">
    <div class="box-body" >
        <div class="row">
            <div class="col-sm-4" id="toplogo">
                <img id="halimage" src="mapview/images/gpstracker-man-blue-37.png">Tracker by Intime Information systems Pvt Ltd
            </div>
